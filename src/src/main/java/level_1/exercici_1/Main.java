...
public class Main {
    ...
    // el nombre d'hores treballades i el multiplica pel preu/hora. Les classes filles l'han de sobreescriure,  emprant @Override.
    ...
    // En els treballadors online, el mètode per calcular el seu sou rebrà per paràmetre el nombre d'hores treballades
    // al mes. A l'hora de calcular el sou es multiplicarà el nombre d'hores treballades pel preu/hora i se li sumarà
